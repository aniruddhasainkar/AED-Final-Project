...
public class BoneMarrowRequestJPanel extends javax.swing.JPanel {
    ...
    public BoneMarrowRequestJPanel(User userAccount, BoneMarrowBankOrganization bmBankOrganization, Enterprise enterprise, Network network, EcoSystem system) {
        initComponents();
        ...
        tblBoneMarrowCoordinator.getTableHeader().setDefaultRenderer(new MagicTable());
        tblHlaAvailability.getTableHeader().setDefaultRenderer(new MagicTable());
