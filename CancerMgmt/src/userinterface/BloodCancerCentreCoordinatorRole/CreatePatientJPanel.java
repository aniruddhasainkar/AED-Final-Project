...
public class CreatePatientJPanel extends javax.swing.JPanel {
    ...
    CreatePatientJPanel(EcoSystem system, User userAccount, Network network) {
        initComponents();
        ...
        tblPatient.getTableHeader().setDefaultRenderer(new MagicTable());
        tblRequest.getTableHeader().setDefaultRenderer(new MagicTable());
