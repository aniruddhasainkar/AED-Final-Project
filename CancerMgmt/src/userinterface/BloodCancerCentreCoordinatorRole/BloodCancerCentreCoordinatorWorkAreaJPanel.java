...
public class BloodCancerCentreCoordinatorWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public BloodCancerCentreCoordinatorWorkAreaJPanel(User account,BloodCancerCentreOrganization cancerCentreOrganization, Enterprise enterprise, EcoSystem system, Network network) {
        initComponents();
        this.system = system;
    ...
    private void initComponents() {
        ...
        btnProfile = new MagicLabel();
        jPanel3 = new javax.swing.JPanel();
        btnManageRequests = new MagicLabel();
        btnReceiveRequests = new MagicLabel();
        btnPatientStatus = new MagicLabel();
