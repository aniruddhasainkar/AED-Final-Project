...
public class ManageMedicalTechnicianRequests extends javax.swing.JPanel {
    ...
    public ManageMedicalTechnicianRequests(EcoSystem system, User userAccount, MedicalTechnicianOrganization medTechOrganization, Enterprise enterprise, Network network) {
//        System.out.println("Inside the non working panel");
        ...
        tblOrganisationDonors.getTableHeader().setDefaultRenderer(new MagicTable());
        tblMedTechDonors.getTableHeader().setDefaultRenderer(new MagicTable());
