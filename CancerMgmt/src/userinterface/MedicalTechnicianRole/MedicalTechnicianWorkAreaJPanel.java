...
public class MedicalTechnicianWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public MedicalTechnicianWorkAreaJPanel(User account, MedicalTechnicianOrganization pathoorganization, Enterprise enterprise, EcoSystem business, Network network) {
        initComponents();
