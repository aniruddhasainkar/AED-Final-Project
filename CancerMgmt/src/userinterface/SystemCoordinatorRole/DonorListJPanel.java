...
public class DonorListJPanel extends javax.swing.JPanel {
    ...
    public DonorListJPanel(User userAccount, EcoSystem system, Network network) {
        initComponents();
        this.userAccount = userAccount;
        this.system=system;
        this.network=network;
        
        tblDonors.getTableHeader().setDefaultRenderer(new MagicTable());
        tblHospital.getTableHeader().setDefaultRenderer(new MagicTable());
        tblAssignment.getTableHeader().setDefaultRenderer(new MagicTable());
