...
public class ManageEnterpriseAdminJPanel extends javax.swing.JPanel {
    ...
    public ManageEnterpriseAdminJPanel(JPanel userProcessContainer, EcoSystem system) {
        ...
        enterpriseJTable.getTableHeader().setDefaultRenderer(new MagicTable());
        tblAdminUserName.getTableHeader().setDefaultRenderer(new MagicTable());
        populateTable();
...
private boolean checkUserIdExists(String userName) {
    ...
    private void populateTable() {
        ...
        private void populateAdminTable(Enterprise enterprise1) {
            ...
            for (User user : enterprise1.getUserAccountDirectory().getUserAccountList()) {
    ...
    private void btnCreateAdminActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateAdminActionPerformed
        ...
        User account = enterprise.getUserAccountDirectory().createUserAccount(username, password, employee, new AdminRole());
