...
public class ManageLegalOfficerRequestJPanel extends javax.swing.JPanel {
    ...
    private LegalOrganization legalofficerorganization;
    private Enterprise enterprise;
    private DB4OUtil dB4OUtil = DB4OUtil.getInstance();
    
    
    public ManageLegalOfficerRequestJPanel(EcoSystem system, User userAccount, LegalOrganization legalofficerorganization, Enterprise enterprise) {
        initComponents();
        this.system = system;
        ...
        tblLegalOrganisation.getTableHeader().setDefaultRenderer(new MagicTable());
        tblLegalOfficer.getTableHeader().setDefaultRenderer(new MagicTable());
