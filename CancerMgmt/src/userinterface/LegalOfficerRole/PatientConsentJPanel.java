...
public class PatientConsentJPanel extends javax.swing.JPanel {
    ...
    public PatientConsentJPanel(EcoSystem system, User userAccount, Network network) {
        initComponents();
        this.system = system;
        this.userAccount = userAccount;
        this.network = network;
        tblPatientConsent.getTableHeader().setDefaultRenderer(new MagicTable());
    ...
    private void btnApprovalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApprovalActionPerformed
        ...
        User userAc = null;
        for (User userAcc: org.getUserAccountDirectory().getUserAccountList()){
            userAc = userAcc;
