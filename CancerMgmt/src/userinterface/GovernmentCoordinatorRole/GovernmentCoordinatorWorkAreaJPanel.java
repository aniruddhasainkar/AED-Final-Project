...
public class GovernmentCoordinatorWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public GovernmentCoordinatorWorkAreaJPanel(User account, GovernmentOrganization govtorganization, Enterprise enterprise, EcoSystem business, Network network) {
        initComponents();
        this.system = system;
