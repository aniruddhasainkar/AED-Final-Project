...
public class ManageDoctorRequestJPanel extends javax.swing.JPanel {
    ...
    public ManageDoctorRequestJPanel(EcoSystem system, User userAccount, DoctorOrganization doctorOrganization, Enterprise enterprise) {
        initComponents();
        this.system = system;
        ...
        tblDoctorOrganisation.getTableHeader().setDefaultRenderer(new MagicTable());
        tblDoctor.getTableHeader().setDefaultRenderer(new MagicTable());
